                ...
                <div className="card ">
                    <div className="row mb-4">
                        <div className="col-md-4 col-sm-4 col-xs-4">
                            <div className="footer-text pull-left">
                                ...
                                <p className="card-text">
                                    The main objective of the proposed cochlier Inpant User App
                                ...
                                <div className="social mt-2 mb-3">
                                    ...
                                    <i className="fa fa-github" onClick={() => { window.location.replace("https://github.com/IT21280474/hear_link_rp") }}></i>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-md-2 col-sm-2 col-xs-2">
                            ...
                            <ul>
                                <li>Anjana Nuwanpriya</li>
                                <li>Malith Madushan</li>
                                <li>Shashini Perera</li>
                                <li>Sadil Dissanayaka</li>
                            </ul>
                        </div>
                        <div className="col-md-2 col-sm-2 col-xs-2">
                    ...
                    <div className="row" style={{ fontSize: "10px", textAlign: "center" }}>
                        <div>
                            Designed and Developed by HearLink Team <br />
                        </div>
                    </div>
                </div>
            </div>
